addEventListener("DOMContentLoaded", (event) => {
    ...
    //     const listOfQuestionsContainer = document.getElementById("list-of-questions-container");
    //     const listOfQuestions = document.getElementById("list-of-questions");
    //     const categoriesSection = document.getElementById("categories-section");;//document.getElementById("list-of-categories");
    //     const questionsSection = document.getElementById("questions-section");
    //     const questionDisplayed = document.getElementById("question-displayed");
    //     const questionTypeDisplayed = document.getElementById("question-type-displayed");
    ...
    //     const randomizeNav = document.getElementById("random-nav");
    ...
    //     function showChoice() {
    //         //Show choice buttons
    //         choiceBtnContainer.classList.remove('hide');
    //     }

    //     function showCardList() {
    //         hideGreetingCard();
    //         hideCategoriesSectionContainer();
    //         hideCardQuestion();
    //         hideAboutSectionContainer();
    ...
    //         displayPopulateMainQuestionCard(questionPointer);
    ...
    //         //Showing greeting card
    //         greetingCard.classList.remove('hide');
    //     }
    ...
    //     function hideAboutSectionContainer() {
    //         if (!aboutSection.classList.contains('hide')) {
    //             aboutSection.classList.add('hide');
    //         }
    //     }

    //     function hideCategoriesSectionContainer() {
    //         if (!categoriesSection.classList.contains('hide')) {
    //             categoriesSection.classList.add('hide');
    //         }
    //     }

    //     function hideListOfQuestionsContainer() {
    //         if (!listOfQuestionsContainer.classList.contains('hide')) {
    //             listOfQuestionsContainer.classList.add('hide');
    //         }
    //     }

    //     function hideGreetingCard() {
    //         if (!greetingCard.classList.contains('hide')) {
    //             greetingCard.classList.add('hide');
    //         }
    //     }

    //     function hideCardQuestion() {
    ...
    //         questionPointer = Math.floor(Math.random() * questions.length)
